...
$r = mysqli_query($conn,$q);
    ...
    <td style="font-size: 20px;"><b>FROM:</b>
         <br><br><input  style="font-size: 19px;" name ="namef" value="<?php echo " ".$row['name']; ?>"></td></tr>
          <td style="font-size: 20px;"><b>TO:</b>
          <br><br> <select style="font-size: 19px;" name="namet" >
...
if(isset($_POST['insert']))
{
   ...
   $query_run=mysqli_query($conn,$ag);
    ...
    $q="insert into transact(namef,  namet,amount) VALUES ('$namef', '$namet', '$amount')";
